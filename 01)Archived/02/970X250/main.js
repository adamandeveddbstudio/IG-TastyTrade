...
function animate() {
  ...
  tl.addLabel('frame_1', 0.5)
    ...
    .to('#right_content', 2, { width: '115%', ease: Power1.easeNone }, "frame_1+=4")
    .to(['#faceL', '#faceR',], 2, { x: '-65%', ease: Power1.easeNone }, "frame_1+=4")
    .to(['#h1R',], 0.5, { autoAlpha: 0, ease: Power1.easeIn }, "frame_1+=6")
    .to(['#right_content'], 0, { width: '100%' }, "frame_1+=6.5")


  tl.addLabel('frame_2', 7)
