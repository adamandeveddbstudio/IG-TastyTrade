...
function animate() {
  ...
  tl.addLabel('frame_1', 0.5)
    .to('#right_content', 0.7, { width: 'calc(50% - 2px)', ease: Power2.easeOut }, "frame_1")
    ...
    .to(['#faceR'], 1, { x: '-51%', ease: Power2.easeOut }, "frame_1+=3.5")
    .to(['#faceL'], 1, { x: '-50%', ease: Power2.easeOut }, "frame_1+=3.5")
  ...
  tl.addLabel('frame_3', 10)
    // .to(['#h2', '#phn', '#legal'], 0.7, { x: '-100%', autoAlpha: 0, ease: Power2.easeOut }, "frame_3")
    // .to(['#h3'], 0.7, { x: 0, autoAlpha: 1, ease: Power1.easeInOut }, "frame_3")
    .staggerTo(['#h2', '#phn'], 0.5, { autoAlpha: 0, ease: Power2.easeOut }, 0.5, "frame_3")
    .staggerTo(['#h3', '#logo', '#cta'], 0.5, { autoAlpha: 1, ease: Power2.easeOut }, 0.5, 'frame_3+=1')
